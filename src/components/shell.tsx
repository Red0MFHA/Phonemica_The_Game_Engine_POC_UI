    ...
    <div className="flex min-h-screen">
      <aside className="w-64 shrink-0 border-r border-slate-200 bg-white">
        <div className="flex items-center gap-2 border-b border-slate-100 px-4 py-4">
          ...
          <div>
            <p className="text-sm font-bold text-slate-900 tracking-tight">PHONOVA</p>
        ...
        <nav className="px-3 py-3">
          {nav.map((group) => (
            <div key={group.section} className="mb-4">
              <p className="px-3 pb-1 text-[10px] font-semibold uppercase tracking-wider text-slate-400">{group.section}</p>
      ...
      <div className="flex flex-1 flex-col">
        <header className="flex items-center justify-between border-b border-slate-200 bg-white px-6 py-3">
          <div className="flex items-center gap-3">
            <span className="text-xs font-medium text-slate-400">Adaptive Speech Intelligence Platform</span>
          </div>
          <div className="flex items-center gap-3">
            ...
            <Link href="/auth/login" className="flex items-center gap-2 rounded-lg p-2 text-slate-500 hover:bg-slate-50">
              <LogOut size={18} />
            </Link>
          </div>
        </header>
